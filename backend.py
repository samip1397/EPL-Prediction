...
class backend:
	def pred(home1,away1):
		...
		print(dictionary.loc['West Ham','1'],"check")
		prediction_example = logreg.predict([[label_enc.transform([home1])[0],label_enc.transform([away1])[0],dictionary.loc[home1,'1'],dictionary.loc[away1,'1'],dictionary.loc[home1,'2'],dictionary.loc[away1,'3']]])
